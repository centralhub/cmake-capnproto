...
require_targets(capnp capnp-c capnp_c) 
...
function(add_capnproto schema_file)
    ...
    add_custom_command(
        ...
        DEPENDS ${actual_source} capnp capnp-c
        COMMAND capnp compile -o $<TARGET_FILE:capnp-c> -I $<TARGET_PROPERTY:capnp-c,capnp_include_path> --src-prefix=${actual_source_dir} ${actual_source}
    ...
    target_include_directories(${libname} PUBLIC ${CMAKE_CURRENT_BINARY_DIR} $<TARGET_PROPERTY:capnp-c,capnp_include_path>)
